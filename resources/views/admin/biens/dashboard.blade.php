...
<body class="bg-slate-50 text-slate-800">
  ...
  transition-transform duration-300">
      ...
      <nav class="p-4 space-y-1 text-sm">
        <a class="block px-3 py-2 rounded-lg bg-blue-900">Dashboard</a>
        <a class="block px-3 py-2 rounded-lg hover:bg-blue-900">Biens</a>
        <a class="block px-3 py-2 rounded-lg hover:bg-blue-900">Ajouter</a>
        <a class="block px-3 py-2 rounded-lg hover:bg-blue-900">Utilisateurs</a>
        <a class="block px-3 py-2 rounded-lg hover:bg-blue-900">Paramètres</a>
      </nav>
      ...
      <header class="bg-white border-b sticky top-0 z-10">
        <div class="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between gap-4">
          ...
          <div class="flex items-center gap-3">
            ...
            <button class="relative text-blue-950">
              🔔
        ...
        <div class="bg-white rounded-xl border overflow-hidden w-full">
          ...
          <div class="p-4 border-b flex flex-col sm:flex-row sm:justify-between gap-3 sm:items-center">
            ...
            <div class="flex gap-2">
              ...
              <input placeholder="Rechercher..." class="border rounded-lg px-3 py-2 text-sm w-full sm:w-56">
            </div>
          </div>
              ...
              <tbody>
                ...
                <tr class="border-t hover:bg-slate-50 transition">
                  ...
                  <td class="p-3 text-right space-x-2">
                    ...
                    <!-- DELETE -->
                    <form action="{{route('admin.bien.delete',['id'=>2])}}" method="post">
                      <button class="text-red-600 hover:text-red-800">
                        <i data-lucide="trash-2" class="w-5 h-5"></i>
                      </button>
                    </form>
