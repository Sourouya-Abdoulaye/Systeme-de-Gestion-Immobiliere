...
<body class="bg-slate-100 text-slate-800">
  ...
  <section class="max-w-4xl mx-auto px-6 py-8">
    <form action="{{route('admin.bien.update',['id'=>2])}}" method="Post">
      @csrf
      @method('PUT')
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 space-y-5">
      ...
      <div>
        ...
        <input name="Titre" value="Villa moderne haut standing"
      ...
      <div class="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <select name="Type" class="mt-1 w-full border rounded-xl p-3">
        ...
        <div>
          ...
          <select name="Statut" class="mt-1 w-full border rounded-xl p-3">
      ...
      <div>
        ...
        <input name="Adresse" value="Quartier administratif" class="mt-1 w-full border rounded-xl p-3">
      </div>

      <!-- VILLE / PAYS -->
      <div class="grid grid-cols-2 gap-4">
        <input name="Ville" value="Lomé" class="border rounded-xl p-3">
        <input name="Ville" value="Togo" class="border rounded-xl p-3">
      </div>

      <!-- PRIX -->
      <div>
        <label class="text-sm text-slate-600">Prix</label>
        <input name="Prix" value="120 000 000 FCFA" class="mt-1 w-full border rounded-xl p-3">
      </div>
      ...
      <div class="border border-dashed border-slate-300 rounded-xl p-5 bg-slate-50">
        ...
        <input name="Images" type="file" multiple accept="image/*" class="mt-3 text-sm w-full">
      ...
      <div class="flex gap-3 pt-2">
        ...
        <button type="submit" class="flex-1 bg-blue-900 hover:bg-blue-800 text-white py-3 rounded-xl font-semibold">
